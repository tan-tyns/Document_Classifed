...
if __name__ == "__main__":
    ...
    TEST_FILE_PATH = os.path.join(ROOT_DIR, "data", "raw", "quyet_dinh", "QUYẾT ĐỊNH SỐ 1-222_trang_110.jpg")
    ...
    print("\n" + "="*70)
    print("📋 TRÍCH XUẤT THÔNG TIN TÀI LIỆU (CÓ TÍCH HỢP NLP CLASSIFICATION)")
    print("="*70)
